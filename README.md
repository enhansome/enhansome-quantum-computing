# Awesome Quantum Computing with stars
...
For further resources related to Open Source Quantum Software Projects, please check out qosf's [repo](https://github.com/qosf/os_quantum_software) ⭐ 2,392 | 🐛 9 | 📅 2026-08-24.

## Learning

* [Quantum Katas](https://github.com/Microsoft/QuantumKatas/) ⚠️ Archived - Programming exercises for learning quantum computing and Q#.
* [Qiskit Tutorials](https://github.com/Qiskit/qiskit-tutorial) ⚠️ Archived - Jupyter notebooks simply demonstrating how to use Qiskit.
...
* [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,059 | 🐛 108 | 🌐 Python | 📅 2026-09-11 - Python library for writing, manipulating, and optimizing NISQ circuits to run on quantum computers.
* [PennyLane](http://github.com/XanaduAI/pennylane) ⭐ 3,459 | 🐛 439 | 🌐 Python | 📅 2026-09-12 - Open source framework for quantum computing and quantum machine learning that integrates various other platforms.
* [pyQuil](https://github.com/rigetticomputing/pyquil) ⭐ 1,497 | 🐛 245 | 🌐 Python | 📅 2026-09-12 - Python library for quantum programming using Quil by Rigetti.
* [Covalent](https://github.com/AgnostiqHQ/covalent) ⭐ 869 | 🐛 103 | 🌐 Python | 📅 2026-08-31 - Framework for distributed computing on heterogeneous infrastructure from CPUs to GPUs to quantum computers.
* [Quantum++](https://github.com/vsoftco/qpp) ⭐ 673 | 🐛 2 | 🌐 C++ | 📅 2026-07-20 - High performance modern C++11 quantum computing library.
...
* [Tequila](https://github.com/aspuru-guzik-group/tequila) ⭐ 440 | 🐛 6 | 🌐 Python | 📅 2026-09-01 - An Extensible Quantum Information and Learning Architecture developed by Alan Aspuru-Guzik group (University of Toronto).
* [Blueqat](https://github.com/Blueqat/Blueqat) ⭐ 388 | 🐛 2 | 🌐 Python | 📅 2026-09-02 - Software development kit in Python for quantum gate computing.
...
* [Quantum Computing in Portuguese](https://github.com/smendoncabruna/ComputacaoQuantica) ⭐ 103 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2023-01-29 - A repository with curated content on Quantum Computing in Portuguese.
