...
For further resources related to Open Source Quantum Software Projects, please check out qosf's [repo](https://github.com/qosf/os_quantum_software) ⭐ 2,383 | 🐛 6 | 📅 2026-08-24.
...
* [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,057 | 🐛 108 | 🌐 Python | 📅 2026-08-31 - Python library for writing, manipulating, and optimizing NISQ circuits to run on quantum computers.
* [PennyLane](http://github.com/XanaduAI/pennylane) ⭐ 3,447 | 🐛 432 | 🌐 Python | 📅 2026-09-01 - Open source framework for quantum computing and quantum machine learning that integrates various other platforms.
* [pyQuil](https://github.com/rigetticomputing/pyquil) ⭐ 1,498 | 🐛 242 | 🌐 Python | 📅 2026-08-20 - Python library for quantum programming using Quil by Rigetti.
...
* [Tequila](https://github.com/aspuru-guzik-group/tequila) ⭐ 439 | 🐛 6 | 🌐 Python | 📅 2026-09-01 - An Extensible Quantum Information and Learning Architecture developed by Alan Aspuru-Guzik group (University of Toronto).
* [Blueqat](https://github.com/Blueqat/Blueqat) ⭐ 387 | 🐛 1 | 🌐 Python | 📅 2026-08-29 - Software development kit in Python for quantum gate computing.
